...
cell_options = {
    "パターン1（横16マス × 縦10マス / A4時:約1.7cm角）": (16, 10),
    "パターン2（横21マス × 縦13マス / A4時:約1.3cm角）": (21, 13),
    "パターン3（横26マス × 縦16マス / A4時:約1cm角）": (26, 16),
    "パターン4（横32マス × 縦20マス / A4時:約8mm角）": (32, 20),
    "パターン5（横42マス × 縦26マス / A4時:約6mm角）": (42, 26),
    "パターン6（横52マス × 縦32マス / A4時:約5mm角）": (52, 32)
}
...
for i, (name, ratio) in enumerate(ratios.items()):
    ...
    with cols[i % 2]:
        ...
        st.caption(f"[A3] 約 {w_A3:.1f}m×{h_A3:.1f}m / [A4] 約 {w_A4:.1f}m×{h_A4:.1f}m / [B5] 約 {w_B5:.1f}m×{h_B5:.1f}m")
